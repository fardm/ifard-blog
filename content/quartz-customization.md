...
فایل های من توی این ریپازتوری هست. فایل هایی که ارجاع میدم رو میتونید از اینجا پیدا کنید:
...
کدهای این گرید توی فایل `quartz/styles/custom.scss` هست. با این کامنت مشخص شده:
Callout Grid Layouts
...
برای اینکه بشه توی کوارتز ازش استفاده کرد این ریپو رو فورک کردم و یه تغییراتی توش دادم.

فایل ها و آموزش استفاده ازش اینجاست:
