...
<!-- QueryToSerialize: table without id ("![](" + cover + ")"), file.name, "`" + pages + " صفحه`", rating FROM #Book WHERE date >= date("2023-03-21") AND date <= date("2024-03-19") SORT rating DESC -->
<!-- SerializedQuery: table without id ("![](" + cover + ")"), file.name, "`" + pages + " صفحه`", rating FROM #Book WHERE date >= date("2023-03-21") AND date <= date("2024-03-19") SORT rating DESC -->
...
### 🎓 دوره‌های آموزشی
<br>
<!-- QueryToSerialize: table without id ("![](" + cover + ")"), file.name, "`" + round(length.hours) + " ساعت`", rating FROM #Course WHERE date >= date("2023-03-21") AND date <= date("2024-03-19") SORT rating DESC -->
<!-- SerializedQuery: table without id ("![](" + cover + ")"), file.name, "`" + round(length.hours) + " ساعت`", rating FROM #Course WHERE date >= date("2023-03-21") AND date <= date("2024-03-19") SORT rating DESC -->
...
<br>
<!-- QueryToSerialize: table without id ("![](" + cover + ")"), file.name, "`" + length.minute + " دقیقه`", rating FROM #Podcast WHERE date >= date("2023-03-21") AND date <= date("2024-03-19") SORT rating DESC -->
<!-- SerializedQuery: table without id ("![](" + cover + ")"), file.name, "`" + length.minute + " دقیقه`", rating FROM #Podcast WHERE date >= date("2023-03-21") AND date <= date("2024-03-19") SORT rating DESC -->
...
<br>
<!-- QueryToSerialize: table without id ("![](" + cover + ")"), file.name, "`" + length.minute + " دقیقه`", rating FROM #Media WHERE date >= date("2023-03-21") AND date <= date("2024-03-19") SORT date DESC -->
<!-- SerializedQuery: table without id ("![](" + cover + ")"), file.name, "`" + length.minute + " دقیقه`", rating FROM #Media WHERE date >= date("2023-03-21") AND date <= date("2024-03-19") SORT date DESC -->
...
### 🍿 فیلم و سریال
<div class="overview-3">
<!-- QueryToSerialize: TABLE WITHOUT ID "🎬" as icon, length(rows) + " فیلم" as count, "`" + round(sum(rows.length.hours),1) + " ساعت`" as sum FROM #Movie WHERE type = "movie" AND length != null AND date >= date("2023-03-21") AND date <= date("2024-03-19") GROUP BY "" -->
<!-- SerializedQuery: TABLE WITHOUT ID "🎬" as icon, length(rows) + " فیلم" as count, "`" + round(sum(rows.length.hours),1) + " ساعت`" as sum FROM #Movie WHERE type = "movie" AND length != null AND date >= date("2023-03-21") AND date <= date("2024-03-19") GROUP BY "" -->
...
<br>
<!-- QueryToSerialize: table without id ("![](" + cover + ")"), file.name, "`" + length.minute + " دقیقه`", rating FROM #Movie WHERE type = "movie" AND date >= date("2023-03-21") AND date <= date("2024-03-19") SORT rating DESC -->
<!-- SerializedQuery: table without id ("![](" + cover + ")"), file.name, "`" + length.minute + " دقیقه`", rating FROM #Movie WHERE type = "movie" AND date >= date("2023-03-21") AND date <= date("2024-03-19") SORT rating DESC -->
...
<!-- QueryToSerialize: table without id ("![](" + cover + ")"), file.name, "`" + round(length.hours) + " ساعت`", rating FROM #Movie WHERE type = "series" AND date >= date("2023-03-21") AND date <= date("2024-03-19") SORT rating DESC -->
<!-- SerializedQuery: table without id ("![](" + cover + ")"), file.name, "`" + round(length.hours) + " ساعت`", rating FROM #Movie WHERE type = "series" AND date >= date("2023-03-21") AND date <= date("2024-03-19") SORT rating DESC -->
...
| ![](https://m.media-amazon.com/images/M/MV5BYmU3Yjg0Y2UtN2E5Yy00NzYyLThlNzQtOTI2YWE2OWJhYTUyXkEyXkFqcGc@._V1_FMjpg_UX1000_.jpg)         | Shrinking     | `5 ساعت`                             | ⭐⭐⭐⭐   |
...
<br>
<!-- QueryToSerialize: table without id ("![](" + cover + ")"), file.name, "`" + length.minute + " دقیقه`", rating FROM #Movie WHERE type = "short" AND date >= date("2023-03-21") AND date <= date("2024-03-19") SORT rating DESC -->
<!-- SerializedQuery: table without id ("![](" + cover + ")"), file.name, "`" + length.minute + " دقیقه`", rating FROM #Movie WHERE type = "short" AND date >= date("2023-03-21") AND date <= date("2024-03-19") SORT rating DESC -->
...
<!-- QueryToSerialize: table without id ("![](" + cover + ")"), file.name, "`" + length.minute + " دقیقه`", rating FROM #Documentary WHERE date >= date("2023-03-21") AND date <= date("2024-03-19") SORT rating DESC -->
<!-- SerializedQuery: table without id ("![](" + cover + ")"), file.name, "`" + length.minute + " دقیقه`", rating FROM #Documentary WHERE date >= date("2023-03-21") AND date <= date("2024-03-19") SORT rating DESC -->
...
| ![](https://m.media-amazon.com/images/M/MV5BNDFlNDEzMDctOTZiOS00YmJhLWI4YTctM2IwMmVlZTFiZGQzXkEyXkFqcGc@._V1_FMjpg_UX1000_.jpg)                             | رویاهای دم صبح       | `76 دقیقه`                      | ⭐⭐⭐    |
