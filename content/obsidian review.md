---
title: نرم افزار ابسیدین (Obsidian) چیست؟
aliases:
  - نرم افزار ابسیدین (Obsidian) چیست؟
date: 2023-09-02
lastmod: 2025-04-01
draft: false
tags: 
...
علاوه بر این می‌توانید برای یادداشت‌های خود عنوان‌های مستعار تعریف کنید. بسیار اتفاق می‌افتد که مطلبی را می‌نویسید اما در مراجعات بعدی عنوان آن را به خاطر نمی‌آورید و زمان زیادی را برای پیدا کردن آن صرف می‌کنید. ابسیدین یک روش خیلی ساده برای حل این مشکل دارد. می‌توانید برای یک یادداشت عناوین مستعار مختلفی انتخاب کنید تا در صورت فراموشی عنوان اصلی، با وارد کردن عبارات مشابه نوشته خود را سریع‌تر پیدا کنید. پلاگین Quick switcher که به صورت پیش‌فرض در ابسیدین فعال است به شما اجازه می‌دهد عناوین مستعار را جستجو و پیدا کنید.
![[pic-obsi012.jpg]]
<br/><br/>
...
خوشبختانه بازهم ترفندهایی برای انتشار رایگان نوشته‌ها وجود دارد. اگر مهارت لازم برای راه‌اندازی سایت استاتیک دارید می‌توانید بدون پرداخت هزینه، سایت‌هایی مشابه ابسیدین راه‌اندازی کرده و نوشته‌های خود را به‌راحتی منتشر کنید. به عنوان مثال [[obsidian publish#۱. سایت‌ساز Quartz|کوارتز]] کاملاً شبیه ابسیدین طراحی شده و از اکثر قابلیت‌های آن پشتیبانی می‌کند. سایت من هم که الان رو به روی شماست با کوارتز ساخته شده است.
