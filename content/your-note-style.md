...
یکی از سیستم‌های محبوب برای معمارها [[basb|ساختن مغز دوم (Building a Second Brain)]] است. این سیستم به افراد کمک می‌کند تا یک پایگاه داده شخصی و سازماندهی شده از اطلاعات و ایده‌های خود ایجاد کنند که به راحتی قابل دسترسی و استفاده باشد.
...
یکی از رویکردهای مناسب برای باغبان‌ها [[digital-garden|دیجیتال گاردن]] است. [[zettelkasten|زتلکاستن (zettelkasten)]] نیز یک روش مشابه است که آنها اجازه می‌دهد یادداشت‌های خود را به هم پیوند دهند و شبکه‌ای از ایده‌ها و اطلاعات مرتبط ایجاد کنند.
