...
‌<br>
مسئله من در این نوشته معرفی تکنیک‌ها و روش‌هایی برای شیوۀ نگارش یادداشت‌ها نیست. در [[note taking#چگونه یادداشت برداریم؟| چگونه یادداشت برداریم؟]] مفصل در این مورد توضیح دادم و اشاره کردم که با استفاده از تکنیک‌های مختلف مثل لایه‌بندی مطالب، اتمی نوشتن و ساخت یادداشت‌های بصری می‌توانید یادداشت‌های بهینه و کارآمد بنویسید.
<br>
...
دسته بندی مطالب یکی از راه‌های معمول برای ایجاد نظم است. استفاده از **پوشه‌ها** بر اساس موضوعات مختلف می‌تواند به ایجاد نظم و دسترسی آسان کمک کند. اما این کار ممکن است به مرور زمان به یک مشکل تبدیل شود. پوشه‌ها اجازه ارتباط با سایر مطالب را سلب کرده و نوشته‌ها را [[folder|زندانی می‌کنند]]. فرض کنید یادداشتی بین سه موضوع الف ب و ج مشترک است. اگر در فولدر الف باشد ارتباطش با موضوع ب و ج مشخص نمی‌شود. کپی کردن آن در هر سه فولدر هم روش مناسبی نیست.  استفاده از پوشه‌ها هرچند برای ساماندهی مطالب مفید است اما مانع برقراری روابط و اتصال نوشته‌ها می‌شود.
