...
در این مرحله داده‌ها را دریافت و ذخیره می‌کنیم. این داده‌ها شامل هرچیزی است که شما دریافت می‌کنید و بعدا نیازی دارید آنها را بازیابی کنید؛ کتابی که مطالعه کردید، پادکستی که گوش کردید، ویدئوی که مشاهده کردید و هر داده‌ای که از هر منبعی مصرف کردید.

علاوه بر این، داده‌های دیگری هم هستند که باید آنها را ذخیره کنید؛ مثل گزارش‌ها، فاکتور‌ها، پروژه‌ها، تسک‌ها، مسئولیت ها و اقدامات. این موارد در واقع اطلاعات شخصی یا خصوصی شما است و ارتباط مستقیمی با دانش ندارد اما چون مرز شفافی بین این دسته از اطلاعات و دانش وجود ندارد همه‌ی این‌ها در یک سیستم واحد ذخیره می‌شوند.[^7]

برای ذخیره سازی داده‌های مربوط به دانش می‌توانیم از [[note-taking|یادداشت برداری]] استفاده کنیم. وقتی چیزی را می‌نویسیم، آن را به بند می‌کشیم و اجازه نمی‌دهیم به سادگی از ذهنمان فرار کند. تجربه نشان داده اینکه فقط به مطالعه بسنده کنیم و امیدوار باشیم در ذهنمان باقی بماند، روش مطمئنی نیست و معمولا نتیجه نمی‌دهد.
...
در [[note-taking|یادداشت برداری]] در مورد این موضوع توضیحات کامل‌تری نوشته‌ام:
...
این سیستم توسط فیلسوف آلمانی نیکلاس لومان طراحی شده است. [[zettelkasten|زتلکاستن]] یک سیستم شبکه‌ای برای یادداشت‌برداری و تفکر عمیق است. هر یادداشت به صورت مستقل و با لینک به یادداشت‌های مرتبط ساخته می‌شود، تا ارتباط بین ایده‌ها حفظ شده و دسترسی به اطلاعات آسان‌تر شود.
...
[^7]: در حقیقت این موارد تحت عنوان **مدیریت اطلاعات شخصی (Personal Information Management)** قرار می‌گیرند و سیستم مجزای خود را می‌طلبند. مثلا سیستم GTD بیشتر مربوط به همین اطلاعات شخصی است. در مقابل سیستم زتلکاستن تمرکز بیشتری روی دانش دارد. اما سیستم مغز دوم ترکیبی از هردوی این‌هاست هم شامل دانش است هم اطلاعات شخصی.
